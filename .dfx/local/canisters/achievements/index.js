...
import { idlFactory } from './achievements.did.js';
export { idlFactory } from './achievements.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_ACHIEVEMENTS;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./achievements.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the achievements canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./achievements.did.js")._SERVICE>}
 */
export const achievements = createActor(canisterId);
