...
import { idlFactory } from './solana_bridge.did.js';
export { idlFactory } from './solana_bridge.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_SOLANA_BRIDGE;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./solana_bridge.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the solana_bridge canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./solana_bridge.did.js")._SERVICE>}
 */
export const solana_bridge = createActor(canisterId);
