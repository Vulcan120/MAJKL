...
export const tubeLineThemes: TubeLineTheme[] = [
  {
    id: "default",
    name: "Default",
    displayName: "Tubler Original",
    color: "#FF6B6B",
    textColor: "#FFFFFF",
    unlocked: true,
    description: "The original Tubler theme",
  },
  {
    id: "central",
    name: "Central",
...
const TubeThemeContext = createContext<TubeThemeContextType | undefined>(
  undefined
);
...
export function TubeThemeProvider({ children }: { children: React.ReactNode }) {
  ...
  const currentTheme =
    tubeLineThemes.find((theme) => theme.id === currentThemeId) ||
    tubeLineThemes[0];
